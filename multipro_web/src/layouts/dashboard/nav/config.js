...
const navConfig = [
  ...
  },
  {
    ...
    path: '/dashboard/onboardvendors',
    icon: icon('ic_lock'),
  },
  {
    title: 'ONBOARD RIDERS',
    path: '/dashboard/onboardriders',
    icon: icon('ic_lock'),
  },
  {
    title: 'VERIFY SERVICE PROVIDERS',
    path: '/dashboard/verifyserviceproviders',
    icon: icon('ic_lock'),
  },
  {
    title: 'UPDATE VENDOR PRODUCTS LIST',
    path: '/dashboard/updatevendorproducts',
    icon: icon('ic_lock'),
  },
