...
import OnboardVendors from './pages/OnboardVendors';
import OnboardRiders from './pages/OnboardRiders';
import VerifyServiceProviders from './pages/VerifyServiceProviders';
import UpdateVendorProductsList from './pages/UpdateVendorProductsList';
  ...
  const routes = useRoutes([
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'servicespromotions', element: <ServicePromotions /> },
        ...
        { path: 'onboardvendors', element: <OnboardVendors/>},
        { path: 'onboardriders', element: <OnboardRiders/>},
        { path: 'verifyserviceproviders', element: <VerifyServiceProviders/>},
        { path: 'updatevendorproducts', element: <UpdateVendorProductsList/>},
      ],
    },
